...
<html lang="en">
    <head>
        ...
        <style>
            .fondo{
                background-image: url('assets/fondo-proveedor.jpg');
        ...
        <form action="" method="post">
            <div class="card mx-auto" style="width: 30rem; margin-top: 15rem;">
                <div class="card-body text-center">
                    ...
                    <p class="card-text">¡Registro de proveedor éxitoso!</p>
                    <a href="proveedor.php" class="btn btn-outline-dark">Continuar</a>
                </div>
            </div>
        </form>
    </body>
